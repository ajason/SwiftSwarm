...
Educational Swift framework exploring ergonomic, lightweight multi-agent orchestration. Highly inspired by OpenAI library [swarm](https://github.com/openai/swarm).
